...
def load_model_custom(self, cfg=None, weights=None, verbose=True):
  ...
  weights, _ = attempt_load_one_weight("yolov9e.pt") 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-name',    type=str,   default="yolov9e-increase-augment", help="run name")
    ...
    train_args = dict(project=args.project, 
                      ...
                      shear=90, # (float) image shear (+/- deg)
